        ...
        <div class="container container-1424">
            <div class="row pb-60">
                <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6">
                    <div class="tp-footer-widget mb-40 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".3s">
                        <div class="tp-footer-logo mb-25">
                            <a href="index.html"><img data-width="108"
                                    src="<?php echo get_template_directory_uri();?>/assets/img/logo/logo-yellow.png"
                                    alt=""></a>
                        </div>
                        ...
                        <div class="tp-footer-social">
                            ...
                            <a href="#">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    ...
                                    <circle cx="9.99991" cy="9.99991" r="8.38077" stroke="currentColor"
                                        stroke-width="1.5" />
                                    <path
                ...
                <div class="col-xxl-3 col-xl-2 col-lg-6 col-md-6 col-sm-6">
                    <div class="tp-footer-widget tp-footer-col-2 mb-50 wow fadeInUp" data-wow-duration=".9s"
                        data-wow-delay=".5s">
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                    <div class="tp-footer-widget tp-footer-cta mb-50 bg-position wow fadeInUp" data-wow-duration=".9s"
                        data-wow-delay=".6s"
                        data-img-bg="<?php echo get_template_directory_uri();?>/assets/img/footer/bg-2.jpg">
                        <h3 class="tp-footer-cta-title mb-30"><a class="common-underline"
                                href="https://www.google.com/maps/@41.6758525,-86.2531698,18.17z" target="_blank">6391
                                Elgin St. Celina,<br> Delaware 10299</a></h3>
